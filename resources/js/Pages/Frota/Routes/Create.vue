                        ...
                        <div class="relative w-full z-auto min-h-fit grid grid-cols-6 gap-3">
                            ...
                            <div class="col-span-6 md:col-span-2 mt-2 md:mt-0">
                                ...
                                <VueMultiselect v-model="routeForm.time" :options="$page.props.timetables"
                                                :multiple="false" :disabled="!validateDate(routeForm?.date)"
                                                :close-on-select="true" class="border border-black rounded-md"
                            ...
                            <div class="col-span-6 md:col-span-2 text-left -mt-1.5 md:mt-0">
                                ...
                                <input type="time" v-model="routeForm.duration"
                                       ...
                                       :class="!validateDate(routeForm?.date) ? 'opacity-10 cursor-not-allowed' : ''"
                            ...
                            <div class="col-span-6 md:col-span-3 mt-3 md:mt-0">
                                ...
                                <VueMultiselect v-model="routeForm.branch" :options="props.branches" :multiple="false"
                                                ...
                                                selectLabel="Selecionar" class="border border-black rounded-md"
                            ...
                            <div class="col-span-6 grid grid-cols-8">
                                ...
                                <button type="button" @click="setPassenger(false)"
                                        ...
                                        class="border rounded-md px-4 py-2 transition duration-500 ease select-none focus:outline-none focus:shadow-outline col-span-2 w-full self-center h-28 md:max-h-[41px] md:self-end md:ml-2 mt-6 md:mb-0"
                    ...
                    <div :class="$page.props.app.settingsStyles.main.innerSection" class="py-0.5 rounded mx-2"
                        ...
                        <div class="p-2 rounded-lg overflow-y-auto"
                            ...
                            <button @click="verifyDriverRoute"
                                    class="flex px-2 py-1.5 transition duration-500 ease select-none rounded-md border border-blue-500 dark:border-slate-300 bg-blue-300 hover:bg-blue-400 text-blue-500 hover:text-blue-200 dark:bg-slate-400 dark:hover:bg-slate-600 dark:text-slate-800 dark:hover:text-slate-200 float-right mb-1">
                                Recarregar Rotas
                                <mdicon name="refresh"/>
                            </button>
