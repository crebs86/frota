...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <SubSection>
            ...
            <template #content>
                <div class="flex flex-wrap my-5 -mx-2 height">
                    <div class="w-full lg:w-1/3 p-2">
                        <div
                            class="flex items-center flex-row w-full bg-gradient-to-r dark:from-cyan-500 dark:to-blue-500 from-cyan-400 via-green-400 to-blue-400 rounded-md p-3">
                            <div
                    ...
                    <div class="w-full md:w-1/2 lg:w-1/3 p-2">
                        <div
                            ...
                            <div class="flex flex-col justify-around flex-grow ml-5 text-white">
                                <div class="text-xs whitespace-nowrap">
                                    Tarefas Previstas/Executadas
                                </div>
                                <div class="">
                                    {{ $page.props.routes_count ?? '-' }}/{{ $page.props.exec_routes ?? '-' }}
                                </div>
                            </div>
                            <div class=" flex items-center flex-none text-white">
                                <Link :href="route('frota.all-routes')">
                                <mdicon name="chevron-right" />
                                </Link>
                            </div>
                        </div>
