...
function updateRoute() {
    let putRoute = isRequest ? 'frota.request.update' : route('frota.routes.route.update', props.routeForEdition.id)
        ...
        <div v-if="props.routeForEdition"
            ...
            <div class="overflow-x-auto grid grid-cols-3 gap-3">
                ...
                <div class="col-span-3 md:col-span-2">
                    ...
                    <VueMultiselect v-model="props.routeForEdition.driver" :options="props.drivers"
                        :multiple="false" :close-on-select="true" placeholder="Motorista" :custom-label="drivers"
                        selectLabel="Selecionar" deselectLabel="Remover" />
                ...
                <div class="col-span-3 md:col-span-2">
                    ...
                    <VueMultiselect v-model="props.routeForEdition.branch" :options="$page.props.branches"
                        :multiple="false" :close-on-select="true" placeholder="Unidade" label="name" track-by="id"
                ...
                <div class="col-span-3 mb-4 -mt-2">
                    <span v-for="(p, i) in props.routeForEdition.passengers" :key="'ps_' + i" class=" inline-flex">
                        {{ p }}
