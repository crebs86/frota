...
<template>
    <div
        ...
        <div class="relative my-6 mx-auto w-11/12 md:w-10/12 max-w-6xl h-5/6">
            <!--content-->
            <div class="border-0 rounded-lg shadow-lg relative flex flex-col w-full outline-none focus:outline-none"
                ...
                <!--body-->
                <div class="relative p-6 grid grid-cols-1 md:grid-cols-2 gap-2">
                    <div class="grid grid-cols-1 col-span-2 md:col-span-1">
                        ...
                        <div v-else class="min-h-[43px]"></div>
                    </div>
                    <div class="grid grid-cols-1 col-span-2 md:col-span-1">
                        <label class="text-sm text-gray-500 dark:text-gray-400">
                            Hora
                    ...
                    <div class="col-span-2 overflow-x-auto">
                        ...
                        <table class="min-w-full">
                            <thead>
                            <tr>
                                <th class="p-1.5 md:px-3 md:py-3 border-b-2 border-gray-300 text-center leading-4 tracking-wider">
                                    Hora Abastecimento
                                </th>
                                <th class="p-1.5 md:px-3 md:py-3 border-b-2 border-gray-300 text-center leading-4 tracking-wider">
                                    Quantidade
                            ...
                            <tr v-for="(f,i) in fills" :key="'fills_' +i">
                                <th class="px-3 py-1.5 md:px-6 md:py-3 whitespace-no-wrap border-b border-gray-500 text-center">
