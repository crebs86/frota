                    ...
                    <div class="p-2 rounded-lg min-h-[calc(100vh/1.33)]"
                        ...
                        <div v-if="canEdit">
                            ...
                            <VueMultiselect v-model="driverForm.carro_favorito" :options="$page.props.cars"
                                            ...
                                            placeholder="Carro favorito" :custom-label="carName" label="name"
                                            :showNoOptions="false"
                        ...
                        <div class="mt-1 pl-1.5">
                            <div class="flex w-full mb-5">
                                <label for="deleted_at" class="flex items-center cursor-pointer">
                                    <div class="relative">
                                        <input type="checkbox" id="deleted_at" class="sr-only"
                                               v-model="driverForm.deleted_at"
                                               :disabled="!canEdit"/>
                                        <div class="bg-teal-200 dark:bg-gray-500 w-10 h-4 rounded-full shadow-inner">
                                        </div>
                                        <div
                        ...
                        <div
                            v-if="has($page.props.auth.permissions, ['Motorista Editar']) || has($page.props.auth.roles, ['Super Admin'])">
